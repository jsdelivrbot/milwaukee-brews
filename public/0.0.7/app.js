...
var ViewModel = function () {
  ...
  _createClass(ViewModel, [{
    ...
    value: function initMarkers() {
      ...
      this.places().forEach(function (placeModel) {
        ...
        placeModel.marker.addListener('click', function () {
          return self.revealMarker.call(self, placeModel);
        });
    ...
    value: function getMapZoom() {
      this.mapFullZoom = window.innerWidth > 1000 && window.innerHeight > 900 ? 15 : 14;
    ...
    key: 'revealMarker',
    value: function revealMarker(placeModel) {
    ...
    key: 'centerZoomIn',
    value: function centerZoomIn(placeModel) {
      var map = this.map;
